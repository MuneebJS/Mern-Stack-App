...
export const fetch_data_nearby = ( dispatch, url) => {
    return dispatch => {
        axios.get(url)
            .then(
            response => {
            ...
            error => {
                ...
                dispatch(fetch_nearby_rej('Error in fetching data'));
            }
            )
    }
}
...
export const get_direction = (dispatch, url) => {
    return async (dispatch) => {
        ...
        .catch((err) => {
            ...
            //  try  {
            //     // let resp = await fetch('https://maps.googleapis.com/maps/api/directions/json?origin=24.8841584,67.1379614&destination=24.882830499999997,67.0680423')
